...
export async function generateMetadata({
	...
	if (slug === "scraping-data-with-devtools-and-har-files") {
		slug = "scraping-data-with-devtools-and-har-files-47m1";
	} else if (slug === "the-compromise-of-a-production-vps") {
		slug = "the-compromise-of-a-production-vps-4065";
	}
